...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "reportgenerator" because\n';
  ...
  $wnd.__gwt_activeModules['reportgenerator'] = {
 ...
 * "/reportgenerator.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['reportgenerator'].superdevmode = true;

  var expectedSuffix = '/reportgenerator.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + reportgenerator + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:reportgenerator';
  var devModeSessionKey = '__gwtDevModeSession:reportgenerator';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/reportgenerator/reportgenerator.nocache.js';
  ...
  $wnd.__gwt_activeModules['reportgenerator'].canRedirect = true;
  $wnd.__gwt_activeModules['reportgenerator'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING reportgenerator';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/reportgenerator?user.agent=' + ua + '&_callback=' + callback;
