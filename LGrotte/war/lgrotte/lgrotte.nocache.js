...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "lgrotte" because\n';
  ...
  $wnd.__gwt_activeModules['lgrotte'] = {
    'moduleName' : 'lgrotte',
    'bindings' : function() {
      return {};
    }
 ...
 * "/lgrotte.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['lgrotte'].superdevmode = true;

  var expectedSuffix = '/lgrotte.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + lgrotte + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:lgrotte';
  var devModeSessionKey = '__gwtDevModeSession:lgrotte';
  ...
  $wnd.__gwt_activeModules['lgrotte'].canRedirect = true;
  $wnd.__gwt_activeModules['lgrotte'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/lgrotte?user.agent=' + ua + '&_callback=' + callback;
