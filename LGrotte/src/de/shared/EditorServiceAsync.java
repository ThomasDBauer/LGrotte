...
public interface EditorServiceAsync {
	...
	void getProfilEintraege(String Email, AsyncCallback<Profil> callback)
			throws Exception;
	...
	void getMerktettelProfileByOwner(AsyncCallback<Vector<Profil>> callback)
			throws Exception;

	void insertKontaktsperren(Vector<String> emails, AsyncCallback callback)
			throws Exception;

	void getSuchprofileByName(String suchprofilname,
			AsyncCallback<Suchprofil> callback) throws Exception;

	void insertProfilInfo(ProfilInfo pi, AsyncCallback callback)
			throws Exception;
